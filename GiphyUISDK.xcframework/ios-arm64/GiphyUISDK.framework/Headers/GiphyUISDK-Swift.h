...
typedef SWIFT_ENUM(NSInteger, GPHAgeGroup, open) {
  GPHAgeGroupAge18_24 = 0,
  GPHAgeGroupAge25_34 = 1,
  GPHAgeGroupAge35_44 = 2,
  GPHAgeGroupAge45_54 = 3,
  GPHAgeGroupAge55_64 = 4,
  GPHAgeGroupAge65_plus = 5,
};
...
@class GPHBottleTransferData;
/// Represents a Giphy Bottle Data
SWIFT_CLASS("_TtC10GiphyUISDK13GPHBottleData")
@interface GPHBottleData : NSObject
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable tags;
/// Unique identifier
@property (nonatomic, readonly, copy) NSString * _Nullable tid;
/// Transfer data
@property (nonatomic, readonly, strong) GPHBottleTransferData * _Nullable tdata;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// Represents the transfer data inside the Bottle Data
SWIFT_CLASS("_TtC10GiphyUISDK21GPHBottleTransferData")
@interface GPHBottleTransferData : NSObject
/// URL to redirect out of the app
@property (nonatomic, readonly, copy) NSString * _Nullable clickOutUrl;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, copy) NSString * _Nullable dobISOString;
...
typedef SWIFT_ENUM(NSInteger, GPHGender, open) {
  GPHGenderMale = 0,
  GPHGenderFemale = 1,
  GPHGenderOther = 2,
};
...
SWIFT_ENUM_FWD_DECL(NSInteger, GPHRenditionType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, GPHMediaType)
SWIFT_ENUM_FWD_DECL(NSInteger, GPHRatingType)
@class NSDate;
@class GPHVideo;
...
@interface GPHMedia (SWIFT_EXTENSION(GiphyUISDK))
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable injectedPixels;
@end

SWIFT_PROTOCOL("_TtP10GiphyUISDK17TrackingMetaMedia_")
@protocol TrackingMetaMedia
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nullable responseId;
@property (nonatomic, readonly, copy) NSString * _Nullable pingbacksEventType;
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Nullable pingbacksAttributes;
@property (nonatomic, readonly, copy) NSString * _Nullable analyticsResponsePayload;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable bottleDataTags;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable injectedPixels;
@end

@interface GPHMedia (SWIFT_EXTENSION(GiphyUISDK)) <TrackingMetaMedia>
@property (nonatomic, copy) NSString * _Nullable pingbacksEventType;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable bottleDataTags;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, GPHThemeType)
@class UIColor;
@class UIFont;
...
- (id <TrackingMetaMedia> _Nullable)trackingMediaForIndexPath:(NSIndexPath * _Nonnull)item SWIFT_WARN_UNUSED_RESULT;
- (BOOL)mediaIsLoadedAtIndexPath:(NSIndexPath * _Nonnull)item SWIFT_WARN_UNUSED_RESULT;
@optional
- (void)impressionOccurredWithMedia:(id <TrackingMetaMedia> _Nonnull)media;
@end

SWIFT_CLASS("_TtC10GiphyUISDK18GPHTrackingManager")
@interface GPHTrackingManager : NSObject
- (void)updateTracking;
+ (BOOL)trackWithMedia:(id <TrackingMetaMedia> _Nonnull)media userID:(NSString * _Nonnull)userID actionType:(enum GPHActionType)actionType;
+ (void)reset;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) BOOL disableEmojiVariations;
