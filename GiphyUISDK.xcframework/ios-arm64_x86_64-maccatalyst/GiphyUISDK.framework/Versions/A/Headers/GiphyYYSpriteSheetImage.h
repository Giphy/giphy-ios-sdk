...
/**
 ...
 The animation can be played by GiphyYYAnimatedImageView.
 ...
 Sample Code:
    ...
    GiphyYYSpriteSheetImage *sprite;
    sprite = [[GiphyYYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    GiphyYYAnimatedImageView *imgView = [GiphyYYAnimatedImageView new];
 ...
 Sample Code:
    ...
    GiphyYYSpriteSheetImage *sheet = ...;
    UIImageView *imageView = ...;
    imageView.image = sheet;
    imageView.layer.contentsRect = [sheet contentsRectForCALayerAtIndex:6];
 
 */
@interface GiphyYYSpriteSheetImage : UIImage <GiphyYYAnimatedImage>
