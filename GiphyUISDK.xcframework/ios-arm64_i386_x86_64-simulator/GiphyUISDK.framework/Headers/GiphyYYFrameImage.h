...
/**
 ...
 Sample Code:
     ...
     GiphyYYFrameImage *image = [GiphyYYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     GiphyYYAnimatedImageView *imageView = [GiphyYYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface GiphyYYFrameImage : UIImage <GiphyYYAnimatedImage>
...
/**
 ...
 @return An initialized GiphyYYFrameImage object, or nil when an error occurs.
 */
